...
# tests to see that polymer starts with all tokens
# def test_correct_token_assignment(dutch_auction):
#     startingTokens = TOTAL_TOKENS
#     startingPolymerTokens = dutch_auction.tokensAvailable()
#     assert startingTokens == startingPolymerTokens


# makes sure polymer loses tokens when tokens are purchased
# def test_polymer_holdings_decrease(dutch_auction):
